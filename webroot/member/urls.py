...
urlpatterns = patterns('member.views',
    ...
    url(r'^connect/fb/callback$', 'connect_facebook_callback', name='connect_facebook_callback'),
    url(r'^connect/fb/destroy$', 'disconnect_facebook', name='disconnect_facebook'),
    url(r'^signin/fb$', 'signin_with_facebook', name='signin_with_facebook'),
    url(r'^signin/fb/callback$', 'signin_with_facebook_callback', name='signin_with_facebook_callback')
)